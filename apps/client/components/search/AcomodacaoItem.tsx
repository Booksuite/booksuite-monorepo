...
import { Button, Flex, RadioGroup, SimpleGrid, Stack } from '@chakra-ui/react'
...
export function AcomodacaoItem({
    property,
    onAddToCart,
    ...props
}: AcomodacaoItemProps) {
                    ...
                    <Flex justifyContent={'space-between'} alignItems={'end'}>
                        <div>
                            ...
                            <p className="mb-0">
                                ...
                                <small className="clr-green text-[0.9375rem] font-medium">
                                    -10% Pix
                                </small>
                                <br />
                        ...
                        <RadioItem value="1">
                            <SimpleGrid width={'100%'} columns={2} gap={2}>
                                <div className=" text-[0.9375rem]">
                                    <p className="mb-0 clr-primary font-medium">
                                        03/06/2024 a 05/06/2024
                                    </p>
                                    <small className="mb-0 text-[0.8125rem]">
                                        De segunda-feira à terça-feira (2
                                        noites)
                                    </small>
                                </div>
                                ...
                                <div className="text-right">
                                    <p className="mb-0">
                                        ...
                                        <span className="clr-green font-medium">
                                            R$ 3.402,00
                                        </span>
                                    </p>
                                    <p className="mb-0">
                                        <small className=" text-[0.8125rem]">
                                            ou no cartão de crédito em até
                                        </small>
