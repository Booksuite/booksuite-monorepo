                            ...
                            <div className="relative aspect-[18/10] min-h-[400px] ">
                                ...
                                <div className="absolute top-2 left-[35%] ">
                                    <button
                                        ...
                                        className="bg-white/80 backdrop-blur-sm px-2.5 py-2 rounded-lg flex items-center gap-1.5 hover:bg-white/90 transition-colors"
                                    >
                                        <Images className="w-4 h-4" />
                                    </button>
                                </div>
                                <div className="absolute bg-black/50 w-full bottom-0">
                                    <div className="flex items-center gap-2 ml-3 mt-5 gap-[10%]">
                                    ...
                                    <div className="flex items-center">
                                        <div className="text-white ml-3 mb-5">
                                            <p className="text-sm">
                                                A partir de
                                            </p>
