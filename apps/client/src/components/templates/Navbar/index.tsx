            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    <Link href="/" className="flex items-center">
                        <Avatar className="w-16 h-16 border-2 border-amber-800 bg-amber-100">
                            <AvatarImage
                                src={
                                    company?.logo ??
                        ...
                        <ul className="flex items-center">
                            {navigationLinks.map((link, index) => (
                                <li key={index}>
                                    <Link
                                        href={link.href}
                                        className="text-white font-medium hover:text-amber-200 transition-colors px-4"
                                    >
                                        {link.name}
                                    </Link>
                                </li>
                    ...
                    <div className="flex items-center">
                        <div className="bg-white rounded-full flex items-center overflow-hidden shadow-sm">
                            ...
                            <button className="bg-amber-800 rounded-full p-3 border-2 border-white">
