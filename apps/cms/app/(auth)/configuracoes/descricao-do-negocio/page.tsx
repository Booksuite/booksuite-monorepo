      ...
      <form onSubmit={handleSubmit}>
        <Stack gap={8}>
          <Flex direction="column" gap={2}>
            <InputBox label="Nome da Propriedade" isDisabled defaultValue={company.name} />
          ...
          <section>
            ...
            <InputBox label="URL de Vídeo do Youtube (opcional)" defaultValue={""} />
            ...
            <Alert className="mt-10" justifyContent={"center"} gap={2}>
              ...
              <AlertDescription>
                A imagem será exibida quando você compartilhar o site em alguma rede social ou
