...
import { Stack, Flex, Button, Alert, AlertDescription, CheckboxGroup } from "@chakra-ui/react";
      ...
      <form onSubmit={handleSubmit}>
        <Stack gap={8}>
          <Flex direction="column" gap={2}>
            ...
            <InputBox label="Percentual cobrado no ato (%)" defaultValue={50} />

            <Alert className="mt-2" justifyContent={"center"} gap={2}>
              <Icons.Info className="!w-auto" />
              <AlertDescription>
                <b>Importante:</b> a garantia da reserva é o valor que o seu cliente deve pagar ao
                efetuar a reserva online.
              </AlertDescription>
            </Alert>
            ...
            <section className="mt-4">
              <Stack spacing={2}>
                ...
                <section>
                  ...
                  <InputBox label="Oferecer desconto no pix em % (opcional)" defaultValue={5} />
                </section>
                ...
                <Stack className="mt-4">
                  ...
                  <InputBox label="Juros para parcelamento em 1x (%)" defaultValue={"0,99"} />
                  <InputBox label="Juros para parcelamento em 2x (%)" defaultValue={"1,99"} />
                  <InputBox label="Juros para parcelamento em 3x (%)" defaultValue={"3,99"} />
                  <InputBox label="Juros para parcelamento em 4x (%)" defaultValue={"5,99"} />
                  <InputBox label="Juros para parcelamento em 5x (%)" defaultValue={"7,99"} />
                  <InputBox label="Juros para parcelamento em 6x (%)" defaultValue={"9,99"} />
                </Stack>
