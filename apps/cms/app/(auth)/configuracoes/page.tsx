  ...
  return (
    <div className="Configuracoes">
      ...
      <InternalMenu.Root>
        ...
        <InternalMenu.Button href={`${fatherPath}/descricao-do-negocio`}>
          <Icons.Hotel />
        ...
        <InternalMenu.Button href={`${fatherPath}/contato-e-redes-sociais`}>
          <Icons.At />
        ...
        <InternalMenu.Button href={`${fatherPath}/regras-de-hospedagem`}>
          <Icons.Offer />
        ...
        <InternalMenu.Button href={`${fatherPath}/politicas-de-reservas`}>
          <Icons.Document />
          Políticas de Reservas
        </InternalMenu.Button>

        <InternalMenu.Button href={`${fatherPath}/politicas-de-cancelamento`}>
          <Icons.File />
        ...
        <InternalMenu.Button href={`${fatherPath}/politica-de-privacidade`}>
          <Icons.List />
