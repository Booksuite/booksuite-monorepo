        ...
        <Stack gap={8}>
          <Flex direction="column" gap={2}>
            ...
            <Flex direction="column" gap={2} className="mt-4">
              ...
              <InputNumberBox name="minNotice" defaultValue={0} label="Idade Inicial" />
              <InputNumberBox name="minNotice" defaultValue={6} label="Idade Final" />
            ...
            <Flex direction="column" gap={2} className="mt-4">
              ...
              <InputNumberBox name="minNotice" defaultValue={7} label="Idade Inicial" />
              <InputNumberBox name="minNotice" defaultValue={17} label="Idade Final" />
              ...
              <InputBox label="Valor por criança por diária (R$)" defaultValue={"150,00"} />
            </Flex>

            <Button variant={"outline"} type="button" leftIcon={<Icons.Plus />} className="mt-4">
