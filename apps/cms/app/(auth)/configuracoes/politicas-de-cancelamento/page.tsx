...
import type { CancelPolicy, UpdateCompanyDTO } from "@/types/Company";
      ...
      <form onSubmit={handleSubmit}>
        <Stack gap={8}>
          <Flex direction="column" gap={2}>
            <h2>Reembolso para cancelamento definitivo ou troca de datas</h2>
            ...
            <Flex direction="column" gap={2} className="mt-4">
              ...
              <InputNumberBox
                ...
                isDisabled
              />
              <InputNumberBox name="minNotice" defaultValue={5} label="Até (dias)" />
            ...
            <Flex direction="column" gap={2} className="mt-4">
              ...
              <InputNumberBox
                ...
                isDisabled
              />
              <InputNumberBox name="minNotice" defaultValue={0} label="Até (dias)" />
            ...
            <TextAreaBox
              ...
              onChange={(e) => {
                console.log(e);
                setFormData({ ...formData, cancelPolicy: e.target.value });
              }}
            />
          </Flex>
