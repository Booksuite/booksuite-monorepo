      ...
      <form onSubmit={handleSubmit}>
        <Stack gap={8}>
          <Flex direction="column" gap={2}>
            ...
            <InputNumberBox name="minNotice" defaultValue={2} label="Mínimo de Diárias Padrão" />
            ...
            <section className="mt-4">
              ...
              <Alert className="mt-2" justifyContent={"center"} gap={2}>
                ...
                <AlertDescription>
                  <b>Atenção:</b> as noites não selecionadas serão automaticamente consideradas dia
                  de semana.
                </AlertDescription>
              </Alert>
            </section>
