        ...
        <Stack gap={8}>
          ...
          <section>
            ...
            <SimpleGrid spacing={2}>
              ...
              <InputBox label="E-mail" type="email" name="email" />
              ...
              <SelectBox
                options={[
                  { value: "Chalé Imperial", label: "Chalé Imperial" },
              ...
              <InputNumberBox
                label={
                  <>
                    Crianças <LabelBadge>(0 a 6)</LabelBadge>
                  </>
                }
                name="childs"
              />
              ...
              <InputNumberBox
                label={
                  <>
                    Crianças <LabelBadge>(7 a 17)</LabelBadge>
                  </>
                }
              />
