...
import { Flex, Stack, Button, CheckboxGroup } from "@chakra-ui/react";
    ...
    <div className="OpcoesDeTarifas">
      <PageHeader.Root>
        <Flex alignItems="center" justifyContent="space-between" gap={2}>
          <PageHeader.BackLink href="/meu-negocio/opcoes-de-tarifas">
            Opcoes de Tarifas
          </PageHeader.BackLink>
      ...
      <Stack gap={8}>
        <Flex direction="column" gap={2}>
          <InputBox label="Nome da Tarifa" defaultValue="Pensão Completa" />
        </Flex>
        ...
        <section>
          <Stack direction={"column"} spacing={2}>
            ...
            <InputBox label="Item incluso" defaultValue={"Café da manhã"} />
            <InputBox label="Item incluso" defaultValue={"Almoço"} />
            <InputBox label="Item incluso" defaultValue={"Jantar"} />
