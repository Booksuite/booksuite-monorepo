        ...
        <List.Root>
          <Link href="pacotes-e-feriados/detalhes">
            <List.Item
              ...
              subtitle={
                <>
                  29/05/2024 a 02/06/2024 <br /> Mínimo 2 diárias
                </>
              }
              status="Ativa"
            />
          ...
          <Link href="pacotes-e-feriados/detalhes">
            <List.Item
              ...
              subtitle={
                <>
                  23/12/2024 a 27/12/2024 <br /> Mínimo 4 diárias
                </>
              }
              status="Programado"
            />
          ...
          <Link href="pacotes-e-feriados/detalhes">
            <List.Item
              ...
              subtitle={
                <>
                  27/12/2023 a 02/01/2024 <br /> Mínimo 6 diárias
                </>
              }
              status="Finalizado"
            />
          ...
          <Link href="pacotes-e-feriados/detalhes">
            <List.Item
              ...
              subtitle={
                <>
                  28/02/2025 a 04/03/2025 <br /> Mínimo 4 diárias
                </>
              }
              status="Inativo"
              statusColor="gray"
