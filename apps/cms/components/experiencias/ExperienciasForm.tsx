...
import React, { useState, type FormEvent, type HTMLAttributes } from "react";
...
interface ExperienciasFormProps<T extends UpdateExperienceDTO | CreateExperienceDTO> {
...
export function ExperienciasForm<T extends UpdateExperienceDTO | CreateExperienceDTO>({
  data,
  isSaving,
  onSubmit,
  ...props
}: ExperienciasFormProps<T>) {
      ...
      <Stack gap={8}>
        <Flex direction="column" gap={2}>
          ...
          <InputNumberBox
            ...
            onChange={(valueAsString: string, valueAsNumber: number) => {
              setFormData({ ...formData, minDaily: valueAsNumber });
            }}
          />
          <InputNumberBox
            name="minNotice"
            ...
            onChange={(valueAsString: string, valueAsNumber: number) => {
              setFormData({ ...formData, minNotice: valueAsNumber });
            }}
          />
        </Flex>
        ...
        <section>
          ...
          <Stack spacing={2}>
            <SwitchBox
              ...
              onChange={(event) => {
                setFormData({ ...formData, onlineSale: event.target.checked });
              }}
            />
            <SwitchBox
              ...
              onChange={(event) => {
                setFormData({ ...formData, panelSale: event.target.checked });
              }}
            />
            <SwitchBox
              ...
              onChange={(event) => {
                setFormData({ ...formData, seasonalSale: event.target.checked });
              }}
            />
          </Stack>
        </section>
        ...
        <section>
          ...
          <CheckboxGroup>
            <Stack spacing={[2]} direction={["column"]}>
              <InputCheckboxBox defaultChecked>Categoria 1</InputCheckboxBox>
              <InputCheckboxBox defaultChecked>Categoria 2</InputCheckboxBox>
        ...
        <section>
          ...
          >
            <Stack spacing={[2]} direction={["column"]}>
              ...
              <InputCheckboxBox name="noites" value={"Segunda-feira"}>
                Segunda-feira
              </InputCheckboxBox>
              <InputCheckboxBox name="noites" value={"Terça-feira"}>
                Terça-feira
              </InputCheckboxBox>
              <InputCheckboxBox name="noites" value={"Quarta-feira"}>
                Quarta-feira
              </InputCheckboxBox>
              <InputCheckboxBox name="noites" value={"Quinta-feira"}>
                Quinta-feira
              </InputCheckboxBox>
              <InputCheckboxBox name="noites" value={"Sexta-feira"}>
                Sexta-feira
              </InputCheckboxBox>
        ...
        <section>
          ...
          <Alert className="mt-10" justifyContent={"center"} gap={2}>
            ...
            <AlertDescription>
              <b>Atenção:</b> as demais fotos da galeria são exibidas conforme as fotos adicionadas
              diretamente nos serviços extras inclusos nesta experiência.
            </AlertDescription>
          </Alert>
        ...
        <section>
          ...
          <PriceList.Root notFoundText="Nenhum Tipo de Cama Adicionado" showAddButton={false}>
            <PriceList.Item title="Cama de casal" defaultValue={1} />
          ...
          <Stack direction={"column"} spacing={2}>
            ...
            <SelectBox
              ...
              onChange={(e: { value: string; label: string }) => {
                setFormData({ ...formData, priceAdjustment: e.value });
              }}
            />
