    ...
    <form {...props} onSubmit={handleSubmit}>
      <Stack gap={8}>
        ...
        <section>
          ...
          <CheckboxGroup>
            <Stack spacing={[2]} direction={["column"]}>
              <InputCheckboxBox defaultChecked>Passeio de Veleiro</InputCheckboxBox>
              <InputCheckboxBox defaultChecked>Passeio de Balão</InputCheckboxBox>
              <InputCheckboxBox>Passeio de Stand-up</InputCheckboxBox>
            </Stack>
          </CheckboxGroup>
