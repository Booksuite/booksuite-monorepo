...
import { ReservationService, ReservationServiceInput } from '@booksuite/sdk'
...
export const ServiceDetails: React.FC<ServiceDetailsProps> = ({
    ...
    const { data: reservation, refetch } = useGetReservationById(
        {
            id: reservationId,
            companyId: companyId,
        },
    ...
    const { data: services } = useSearchServices(
        ...
        {
            query: {
                enabled: !!companyId && openServiceModal,
            },
        },
    )

    const { mutate: updateReservation } = useReservationControllerUpdate({
        mutation: {
            onSuccess: () => {
    ...
    const handleUpdateServices = (newServices: ReservationService[]) => {
        if (!reservation) return

        const servicesInput: ReservationServiceInput[] = newServices.map(
            (service) => ({
    ...
    return (
        <>
            ...
            <ServiceModal
                ...
                initialServices={reservation.services || []}
