    ...
    <div className="DetalhesOfertasECupons">
      <PageHeader.Root>
        <Flex alignItems="center" justifyContent="space-between" gap={2}>
          <PageHeader.BackLink href="/meu-negocio/precos-e-periodos/ofertas-e-cupons">
            Ofertas
          </PageHeader.BackLink>
      ...
      <Stack gap={8}>
        ...
        <section>
          ...
          <CheckboxGroup>
            <Stack spacing={[2]} direction={["column"]}>
              ...
              <InputCheckboxBox defaultChecked>Pix</InputCheckboxBox>
              <InputCheckboxBox>Cartão de Crédito</InputCheckboxBox>
            </Stack>
          </CheckboxGroup>
        </section>
        ...
        <section>
          ...
          <SimpleGrid spacing={2}>
            ...
            <InputBox label="Código do Cupom" defaultValue={"RAMON10"} />
          </SimpleGrid>
        </section>
