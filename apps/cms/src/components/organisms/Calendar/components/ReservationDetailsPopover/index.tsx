...
> = ({ open, anchorEl, onClose, reservation }) => {
    ...
    return (
        ...
        >
            ...
            >
                <Typography fontWeight={600} fontSize={20} color="blueGrey.700">
                ...
                <Stack direction="row" alignItems="center" gap={1}>
                    ...
                    <IconButton size="small" sx={{ color: 'blueGrey.700' }}>
                        <ExpandIcon
                            size={18}
                    ...
                    <IconButton
                        ...
                        onClick={onClose}
                    >
                        <XIcon size={20} color={theme.palette.blueGrey[700]} />
                    </IconButton>
                </Stack>
            </Stack>
            ...
            <Box sx={{ height: 324, overflowY: 'auto', bgcolor: '#fff' }}>
                ...
                <Box px={2} pt={2}>
                    <Stack
                        ...
                        sx={{ cursor: 'pointer' }}
                        onClick={() =>
                            setCollapse((c) => ({ ...c, guests: !c.guests }))
                        }
                    >
                        <Typography
                            fontWeight={600}
